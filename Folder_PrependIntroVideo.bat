...
set "filter_complex=[0:v]fps=!intro_framerate!,scale=1920:1080,fade=t=out:st=!fade_start!:d=1[v0];[1:v]fps=!intro_framerate!,fade=t=in:st=0:d=1[v1];[v0][0:a][v1][1:a]concat=n=2:v=1:a=1[outv][outa]"
